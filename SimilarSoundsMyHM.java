...
{	
	...
	public static void main(String args[]) {
		...
		wordToSound = new LinearProbingMap<>(); // maps <word, sound>
        soundGroupToSimilarWords = new LinearProbingMap<>(); // maps <sound-group, sorted list of words with similar sounds>
